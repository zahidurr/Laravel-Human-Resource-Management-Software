                    ...
                    <div class="block">
                        ...
                        <div class="block-content collapse in">
                            <div class="span12">
                                ...
                                <!-- Form view -->
                                {{ Form::model($department, array('route' => array('admin-panel.departments.update', $department->id), 'method' => 'PUT', 'class'=>'form-horizontal', 'id'=>'department-form')) }}
                                <fieldset>
                                ...
                                ">
                                  ...
                                  <div class="controls">
                                  {{ Form::text('name', Input::old('name'), array('class'=>'input-xlarge focused', 'id'=>'name', 'required'=>'required')) }}
