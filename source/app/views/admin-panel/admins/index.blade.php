                ...
                <div class="row-fluid">
                   ...
                   <div class="block">
                       ...
                       <div class="navbar navbar-inner block-header">
                           <div class="muted pull-left">Admins</div>
                           <div class="pull-right"><a href="{{ URL::to('/admin-panel/admins/create') }}">Create</a></div>
                       </div>
                                   ...
                                   <tbody>
                                       ...
                                       <tr class="gradeA">
                                           ...
                                           <td>
                                               ...
                                               <a href="{{ URL::to('/admin-panel/admins/'. $value->id) }}">{{ $value->first_name }} {{ $value->last_name }}</a></td>
                                           ...
                                           <td class="vert-align">
                                               ...
                                               <a href="#" onClick="confirmAction('<b>{{ $value->first_name }} {{ $value->last_name }}</b>\'s account', '/admin-panel/admins/{{ $value->id }}')" class="btn btn-danger btn-mini">
                                                   <i class="icon-trash icon-white"></i> Delete
                                               </a>

                                                <a href="{{ URL::to('/admin-panel/admins/'.$value->id.'/edit') }}" class="btn btn-primary btn-mini">
