                ...
                <div class="row-fluid">
                    ...
                    <div class="block">
                        ...
                        <div class="navbar navbar-inner block-header">
                            <div class="muted pull-left">Create New Notice</div>
                        </div>
                        ...
                        <div class="block-content collapse in">
                            <div class="span12">
                                ...
                                <!-- Form view  -->
                                {{ Form::open(array('url' => '/admin-panel/notices', 'class'=>'form-horizontal', 'id'=>'notice-form')) }}
                                <fieldset>
                                ...
                                ">
                                  ...
                                  {{ Form::select('viewers', $viewers, Input::old('viewers'), array( 'multiple' => 'multiple', 'id' => 'viewers', 'name' => 'viewers[]', 'class' => 'chzn-select')) }}
