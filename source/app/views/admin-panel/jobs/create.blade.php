                ...
                <div class="row-fluid">
                    ...
                    <div class="block">
                        ...
                        <div class="navbar navbar-inner block-header">
                            <div class="muted pull-left">Create New Job</div>
                        </div>
                        ...
                        <div class="block-content collapse in">
                            <div class="span12">
                                ...
                                <!-- Form view  -->
                                {{ Form::open(array('url' => '/admin-panel/jobs', 'class'=>'form-horizontal', 'id'=>'notice-form')) }}
                                <fieldset>
                                ...
                                ">
                                  ...
                                  <div class="controls">
                                  {{ Form::textarea('description', Input::old('description'), array('class'=>'input-xlarge textarea', 'id'=>'description', 'style'=>'width: 75%', 'placeholder'=>"e.g.<ul><li>Manage and develop IT staff, including, training, evaluation, guidance, discipline </li><li>Perform emergency support duty as and when required by the company</li></ul>" )) }}
