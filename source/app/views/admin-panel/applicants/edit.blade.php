                ...
                <div class="row-fluid">
                    ...
                    <div class="block">
                        ...
                        <div class="navbar navbar-inner block-header">
                            <div class="muted pull-left">Edit Applicant Résumé</div>
                        </div>
                        ...
                        <div class="block-content collapse in">
                            ...
                            <div class="span12">
                               ...
                               <!-- Form view  -->
                                {{ Form::model($applicant, array('route' => array('admin-panel.applicants.update', $applicant->id), 'method' => 'PUT', 'class'=>'form-horizontal', 'id'=>'user-form')) }}
                                ...
                                ">
                                  ...
                                  {{ Form::text('alternative_email', Input::old('alternative_email'), array('class'=>'input-xlarge focused', 'id'=>'alternative_email')) }}
                                    ...
                                    <div role="tabpanel" class="tab-pane fade" id="photograph">
                                        <div class="control-group">
                                          <div class="controls">
                                              {{ Form::file('image', array('onchange' => "uploadImage(this, 'Applicant', $applicant->id);")) }}
                                    ...
                                    <div class="form-actions">
                                      ...
                                      <a class="btn" href="{{ URL::to('/admin-panel/applicants') }}">Cancel</a>
