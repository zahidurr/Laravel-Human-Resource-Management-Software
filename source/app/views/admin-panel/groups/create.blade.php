                ...
                <div class="row-fluid">
                    ...
                    <div class="block">
                        ...
                        <div class="navbar navbar-inner block-header">
                            <div class="muted pull-left">Create New Group</div>
                        </div>
                        ...
                        <div class="block-content collapse in">
                            <div class="span12">
                                ...
                                <!-- Form view  -->
                                {{ Form::open(array('url' => '/admin-panel/groups', 'class'=>'form-horizontal', 'id'=>'group-form')) }}
                                <fieldset>
                                ...
                                ">
                                  ...
                                  {{ Form::select('members', $members, Input::old('members'), array( 'multiple' => 'multiple', 'id' => 'members', 'name' => 'members[]', 'class' => 'chzn-select')) }}
