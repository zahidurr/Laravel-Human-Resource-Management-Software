                ...
                <div class="row-fluid">
                   ...
                   <div class="block">
                       ...
                       <div class="navbar navbar-inner block-header">
                           ...
                           <div class="pull-right"><a href="{{ URL::to('/admin-panel/groups/create') }}">Create</a></div>
                       </div>
                               ...
                               <!-- table -->
                                 <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                                   ...
                                   <tbody>
                                       ...
                                       <tr class="gradeA">
                                           <td><a href="{{ URL::to('/admin-panel/groups/'. $value->id) }}">{{ $value->name }} </a></td>
                                           ...
                                           <td  class="text-center">{{ App::make('UtilController')->totalGroupMembers ($value->id) }}</td>
                                           <td class="vert-align">

                                               <a href="#" onClick="confirmAction('<b>{{ $value->name }}</b>', '/admin-panel/groups/{{ $value->id }}')" class="btn btn-danger btn-mini">
                                                   <i class="icon-trash icon-white"></i> Delete
                                                   </a>



                                                <a href="{{ URL::to('/admin-panel/groups/'.$value->id.'/edit') }}" class="btn btn-primary btn-mini">
