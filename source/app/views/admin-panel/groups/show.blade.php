                ...
                <div class="row-fluid">
                   ...
                   <div class="block">
                       ...
                       <div class="navbar navbar-inner block-header">
                           <div class="muted pull-left">Group Details</div>
                       ...
                       <div class="block-content collapse in">
                           <div class="span12">
                               ...
                               {{ $group->description }}
                               <br>
                               <strong>Creator:</strong> {{ App::make('UtilController')->userFullName ($group->created_by) }}
                               <br>
                               <strong>Total Members:</strong> {{ App::make('UtilController')->totalGroupMembers ($group->id) }}
