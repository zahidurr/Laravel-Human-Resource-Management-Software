                ...
                <div class="row-fluid">
                    ...
                    <div class="block">
                        ...
                        <div class="navbar navbar-inner block-header">
                            <div class="muted pull-left">Review Employee Equipment</div>
                        </div>
                        ...
                        <div class="block-content collapse in">
                            <div class="span12">
                                ...
                                <!-- Form view -->
                                {{ Form::open(array('url' => '/admin-panel/update-moderate-employee-equipment', 'class'=>'form-horizontal')) }}
                                <fieldset>
                                    ...
                                    ">
                                      ...
                                      {{ Form::select('status', array('' => 'Select', '1' => 'Approve', '2' => 'Reject'), $equipment->status, array('class' => 'form-control')) }}
                                    ...
                                    ">
                                      ...
                                      <div class="controls">
                                      {{ Form::textarea('comment',  $equipment->moderator_comment, array('class'=>'input-xlarge focused', 'id'=>'comment', 'placeholder'=>'Write here...')) }}
                                    ...
                                    <div class="form-actions">
                                      ...
                                      <a class="btn" href="{{ URL::to('/admin-panel/employee-equipment-list') }}">Cancel</a>
