                ...
                <div class="row-fluid">
                    ...
                    <div class="block">
                        ...
                        <div class="navbar navbar-inner block-header">
                            <div class="muted pull-left">Edit Leave Request</div>
                        </div>
                        ...
                        <div class="block-content collapse in">
                            <div class="span12">
                                ...
                                <!-- Form view -->
                                {{ Form::model($leave, array('route' => array('employee-panel.leave.update', $leave->id), 'method' => 'PUT', 'class'=>'form-horizontal')) }}
                                <fieldset>
