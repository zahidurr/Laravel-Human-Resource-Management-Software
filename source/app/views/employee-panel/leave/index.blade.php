                ...
                <div class="row-fluid">
                   ...
                   <div class="block">
                       ...
                       <div class="navbar navbar-inner block-header">
                           <div class="muted pull-left">Leave List</div>
                           <div class="pull-right"><a href="{{ URL::to('/employee-panel/leave/create') }}">Create</a></div>
                       </div>
                                 ...
                                 <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                                   ...
                                   <tbody>
                                       ...
                                       <tr class="gradeA">
                                           ...
                                           <td>
                                               <a href="{{ URL::to('/employee-panel/leave/'. $value->id) }}">{{ $value->type }}
                                               </a>
                                           </td>

                                           <td>
                                               {{ date("Y-M-j", strtotime($value->from_date)) }}
                                           </td>

                                           <td>
                                               {{ date("Y-M-j", strtotime($value->to_date)) }}
                                           </td>
                                           ...
                                           <td class="vert-align">
                                               @if($value->status == 3)
                                               <a href="#" onClick="confirmAction('<b>{{ $value->type }}</b>', '/employee-panel/leave/{{ $value->id }}')" class="btn btn-danger btn-mini">
                                                   <i class="icon-trash icon-white"></i> Delete
                                               </a>

                                                <a href="{{ URL::to('/employee-panel/leave/'.$value->id.'/edit') }}" class="btn btn-primary btn-mini">
